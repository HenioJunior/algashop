...
import static com.henio.algashop.ordering.domain.model.product.ProductTestDataBuilder.DEFAULT_PRODUCT_ID;
...
public class ShoppingCartItemTestDataBuilder {
    ...
    private ProductId productId = DEFAULT_PRODUCT_ID;
